...
function PlaygroundHeader() {
  ...
  return (
    <header className="w-full py-6 sticky top-0 z-50 bg-black">
      <div className="relative mx-auto flex w-fit items-center">
        <a href="/assure" className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-20 text-orange-500 hover:text-orange-400 transition-colors">
          <StarIcon />
        </a>
